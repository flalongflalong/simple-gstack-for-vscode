...
For API-only contract drift, prefer `$priv-skill-api-contract`. For schema, SQL, index, migration, or backfill work, prefer `$priv-skill-database-change`.
