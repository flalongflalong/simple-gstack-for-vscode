...
Local targets usually include `skill-bug-fix`, `skill-test-quality`, `skill-code-review`, `skill-eng-planning`, `gstack-qa`, `gstack-review`, and `gstack-implement`.
...
Local targets usually include standalone `skill-*` entries. Promote a pattern into `gstack-*` only when it changes the full engineering OS.
...
Local targets usually include `skill-design-ui`, `gstack-design-consultation`, `gstack-design-shotgun`, `gstack-plan-design-review`, and `gstack-design-review`.
